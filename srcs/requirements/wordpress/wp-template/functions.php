<?php
/**
 * Retrospect functions and definitions
 *
 * @link https://developer.wordpress.org/themes/basics/theme-functions/
 *
 * @package Retrospect
 * @since Retrospect 1.0
 */

declare( strict_types = 1 );

if ( ! function_exists( 'retrospect_unregister_patterns' ) ) :
	/**
	 * Unregister Jetpack patterns and core patterns bundled in WordPress.
	 */
	function retrospect_unregister_patterns() {
		$pattern_names = array(
...
if ( ! function_exists( 'retrospect_setup' ) ) :
	/**
...
add_action( 'after_setup_theme', 'retrospect_setup' );

if ( ! function_exists( 'retrospect_styles' ) ) :
	/**
	 * Enqueue styles.
	 *
	 * @since Retrospect 1.0
	...
	function retrospect_styles() {
		...
		wp_enqueue_style( 'retrospect-style' );

	}

endif;

add_action( 'wp_enqueue_scripts', 'retrospect_styles' );
